...
{
    public class AppointmentParticipantItemViewModel
    {
        public AppointmentParticipantItemViewModel(Guid idAppointment, string name, string cpf, int age, double weight, bool isResponsible)
        {
